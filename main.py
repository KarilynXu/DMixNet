...
from utils.dataloader import CifarLoader, ImagenetLoader, SVHNLoader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./configs/MLPconfig100.json',
    ...
    elif 'SVHN_type' in config['data_params']:
        data_loader = SVHNLoader(config['data_params'])
    if mode == 'train':
